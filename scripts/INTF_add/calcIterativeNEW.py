...
if savefile:
	...
	# sys.stdout = open("./SD_20240817_161845/analysis_161845_scrib_"+ str(trigNum) + "_DEC2025.txt", "w") #### write the output in a file

print ('TRIGGER ', trigNum)
sdStartTime = 19136.### time of the first burst
hour,minute,second = 16,18,45 ##### Changes for different TGFs
time = "161845"

intfFile = 'TAR_intf_241644_azi_cutFeb10.dat'
intfList = READ_INTF(intfFile) ############### Read INTF points #####

lmaFile = 'LMA_240817_161845_cut.txt'
...
intfRange = 3. ### microseconds - range of inft data
